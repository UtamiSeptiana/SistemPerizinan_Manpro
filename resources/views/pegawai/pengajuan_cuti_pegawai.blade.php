...
<div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 mb-4 mb-xl-0">
            <h3 class="font-weight-bold" style="font-size: 25px">Form Pengajuan Cuti Pegawai</h3>
            <hr>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{route('pegawai.pengajuancutipegawaistore')}}" class="form-sample">
              @csrf
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group row">
                    <label class="col-sm-3 col-form-label" for="tgl_mulai">Tanggal</label>
                    <div class="col-sm-9">
              ...
              <a href="{{route('pegawai.approvalpegawai')}}" class="btn btn-light" style="margin-left: 270px">Cancel</a>
