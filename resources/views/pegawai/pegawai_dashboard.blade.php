        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              ...
              <a href="{{route('pegawai.logout')}}" class="dropdown-item">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('pegawai.syaratcutipegawai')}}">Syarat Cuti</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('pegawai.pengajuancutipegawai')}}">Pengajuan Cuti</a></li>
              </ul>
            </div>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{route('pegawai.approvalpegawai')}}">
