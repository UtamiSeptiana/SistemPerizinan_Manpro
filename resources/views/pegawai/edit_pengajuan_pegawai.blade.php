...
<div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 mb-4 mb-xl-0">
            <h3 class="font-weight-bold" style="font-size: 25px">FORM EDIT PENGAJUAN CUTI PEGAWAI</h3>
            <hr>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{url('pegawai/edit'.$data->id)}}" class="form-sample">
                @csrf
                @method('patch')
              <div class="row">
                <div class="col-md-6">
              ...
              <a href="{{route('pegawai.approvalpegawai')}}" class="btn btn-light" style="margin-left: 280px" >Cancel</a>
