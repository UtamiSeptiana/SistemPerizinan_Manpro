        ...
        <div class="card">
          <div class="card-body">
            <div style="margin-left: 710px" class="input-group">
              ...
              <form action="/kepalaruang/approvalkepalaruang" method="GET">
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{route('kepalaruang.pengajuancutikepalaruangedit',$item->nama)}}" class="btn btn-primary btn-sm">Edit</a>
