...
<div class="content-wrapper">
      ...
      <div class="col-md-12 grid-margin">
        <div class="row">
          <div class="col-12 mb-4 mb-xl-0">
            <h3 class="font-weight-bold" style="font-size: 25px">Form Pengajuan Cuti Kepala Ruang</h3>
            <hr>
          </div>
        </div>
      </div>
    ...
    <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{route('kepalaruang.pengajuancutikepalaruangstore')}}" class="form-sample">
              @csrf
              <div class="row">
                <div class="col-md-6">
