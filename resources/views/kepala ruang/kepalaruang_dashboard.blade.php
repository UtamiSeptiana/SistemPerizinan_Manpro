...
<head>
  ...
  <title>Kepala Ruang Panel</title>
  <!-- plugins:css -->
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
            <h4>Pengajuan Izin Kepala Ruang</h4>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              <a href="{{route ('kepalaruang.profile')}}" class="dropdown-item">
                <i class="ti-user text-primary"></i>
                Profile
              </a>
              <a href="{{route('kepalaruang.logout')}}" class="dropdown-item">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          <li class="nav-item">
            <a class="nav-link" href="{{route('kepalaruang.dashboard')}}">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('kepalaruang.syaratcutikepalaruang')}}">Syarat Cuti</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('kepalaruang.pengajuancutikepalaruang')}}">Pengajuan Cuti</a></li>
              </ul>
            </div>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{route('kepalaruang.approvalkepalaruang')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('kepalaruang.persetujuankepalaruang')}}">
              <i class="icon-file menu-icon"></i>
