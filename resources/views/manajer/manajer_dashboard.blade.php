        ...
        <ul class="navbar-nav navbar-nav-right">
          <li class="nav-item nav-profile dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="profileDropdown">
              <a href="{{route ('manajer.profile')}}" class="dropdown-item">
                <i class="ti-user text-primary"></i>
                Profile
              </a>
              <a href="{{route('manajer.logout')}}" class="dropdown-item">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="{{route('manajer.syaratcutimanajer')}}">Syarat Cuti</a></li>
                <li class="nav-item"> <a class="nav-link" href="{{route('manajer.pengajuancutimanajer')}}">Pengajuan Cuti</a></li>
              </ul>
            </div>
          </li>

          <li class="nav-item">
            <a class="nav-link" href="{{route('manajer.approvalmanajer')}}">
          ...
          <li class="nav-item">
            <a class="nav-link" href="{{route('manajer.persetujuanmanajer')}}">
              <i class="icon-file menu-icon"></i>
