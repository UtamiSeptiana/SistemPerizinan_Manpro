...
<div class="content-wrapper">
    ...
    <div class="col-12 grid-margin">
        <div class="card">
          <div class="card-body">
            <form method="POST" action="{{url('manajer/accmanajeredit'.$data->id)}}" class="form-sample">
                @csrf
                @method('patch')
              <div class="row">
                <div class="col-md-6">
              ...
              <div class="row">
                <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <select value="{{ $data->status_manajer }}" name="status_manajer" id="status_manajer" class="form-control">
                          <option value="">--Pilih Status--</option>
                          <option value="Tolak" {{ $data->status_manajer == 'Tolak' ? 'selected' : '' }} >Tolak</option>
                          <option value="Setuju" {{ $data->status_manajer == 'Setuju' ? 'selected' : '' }} >Setuju</option>
                        </select>
                      </div>
                    </div>
                </div>
              ...
              <a href="{{route('manajer.persetujuanmanajer')}}" class="btn btn-light" style="margin-left: 280px">Cancel</a>
